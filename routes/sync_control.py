...
def trigger_products_sync(
    ...
    if effective_store_id:
        ...
        background_tasks.add_task(product_sync_runner.run_product_sync_for_store, SessionLocal, store.id, task_id)
        ...
        for s in stores:
            ...
            background_tasks.add_task(product_sync_runner.run_product_sync_for_store, SessionLocal, s.id, task_id)
