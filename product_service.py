...
class ProductService:
    ...
    # FIXED: Replaced the faulty 'set' method with a reliable 'adjust' method for "On Hand"
    def adjust_on_hand_quantity(self, inventory_item_id: str, location_id: str, on_hand_delta: int) -> Dict[str, Any]:
        """
        Adjusts the 'on hand' inventory quantity for an inventory item at a location.
        """
